...
👉 ESG ETF 3종은 모두 유사한 수준의 ESG 점수를 보이며, ESG 성향이 강하게 반영된 상품임을 확인할 수 있다.

📊 세부 E / S / G 점수
ETF E S G
KODEX_200ESG 5.080707 5.615369 4.666396
SOL_CLIMATE 5.080732 5.615760 4.666192
TIGER_GREEN_NEWDEAL 5.080639 5.615619 4.666260
SOLAR_THEME 5.016880 5.454876 ⬇️ 4.463151 ⬇️⬇️
🔍 해석
ESG ETF 3종은 E / S / G 전반에서 균형 잡힌 구조를 보이며 점수 또한 거의 동일하다.
태양광 ETF(SOLAR_THEME)는 환경(E) 점수는 큰 차이가 없지만,
사회(S)
지배구조(G) 영역에서 점수가 낮아 전체 ESG 점수가 하락하였다.

👉 즉, 특정 친환경 산업(태양광)에 투자하는 ETF가 반드시 ESG 관점에서 우수한 투자 상품이라고 볼 수 없음을 데이터로 확인할 수 있다.
